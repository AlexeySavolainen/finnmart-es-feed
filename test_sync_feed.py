...
class SyncFeedTests(unittest.TestCase):
    ...
    def test_weight_and_shipping_brackets(self):
        ...
        self.assertEqual(feed.shipping_price(10000), "4.90 EUR")
        self.assertEqual(feed.shipping_price(10001), "6.90 EUR")
        self.assertEqual(feed.shipping_price(20000), "6.90 EUR")
        with self.assertRaises(ValueError):
            feed.shipping_price(20001)
        with self.assertRaises(ValueError):
    ...
    def test_offer_contains_spanish_shipping(self):
        ...
        self.assertEqual(values["price"], "4.90 EUR")
    ...
    def test_invalid_weight_uses_one_kilogram(self):
        ...
        self.assertEqual(price.text, "4.90 EUR")
